...
$qry=mysqli_query($link, "SELECT * FROM prod WHERE categoria='Libro'");
...
$vSql = "SELECT * FROM prod WHERE categoria='Libro' "." limit " .$inicio."," .$cantPorPag ." ";
      ...
      if($totalPaginas>1){
        echo "<center> Paginas: ";
          for($i=1; $i<=$totalPaginas;$i++){
              ...
              {
                  echo  "<strong><a href='buscarLibros.php?pagina=" . $i ."'>" . $i . "</a></strong> ";}
                }
                echo "</center>";
              };
