...
$qry=mysqli_query($link, "SELECT * FROM prod WHERE nombre LIKE '%$producto%'");
...
$vSql = "SELECT * FROM prod WHERE nombre LIKE '%$producto%' "." limit " .$inicio."," .$cantPorPag ." ";
      ...
      if($totalPaginas>1){
        echo "<center> Paginas: ";
          for($i=1; $i<=$totalPaginas;$i++){
              ...
              {
                  echo  "<strong><a href='buscador2.php?pagina=" . $i ."'>" . $i . "</a></strong> ";}
                }
                echo "</center>";
              };
