...
$qry=mysqli_query($link, "SELECT * FROM prod WHERE categoria='Accesorio'");
...
$vSql = "SELECT * FROM prod WHERE categoria='Accesorio' "." limit " .$inicio."," .$cantPorPag ." ";
      ...
      if($totalPaginas>1){
        echo "<center> Paginas: ";
          for($i=1; $i<=$totalPaginas;$i++){
              ...
              {
                  echo  "<strong><a href='buscarAccesorio.php?pagina=" . $i ."'>" . $i . "</a></strong> ";}
                }
                echo "</center>";
              };
