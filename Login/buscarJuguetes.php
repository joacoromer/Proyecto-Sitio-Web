...
$qry=mysqli_query($link, "SELECT * FROM prod WHERE categoria='Juguete'");
...
$vSql = "SELECT * FROM prod WHERE categoria='Juguete' "." limit " .$inicio."," .$cantPorPag ." ";
      ...
      if($totalPaginas>1){
        echo "<center> Paginas: ";
          for($i=1; $i<=$totalPaginas;$i++){
              ...
              {
                  echo  "<strong><a href='buscarJuguetes.php?pagina=" . $i ."'>" . $i . "</a></strong> ";}
                }
                echo "</center>";
              };
