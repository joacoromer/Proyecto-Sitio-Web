...
<br> 
<form method="POST" action="modperfilContra.php" >
    ...
    <table align='center'>
            ...
            <td>
            <input type="password" placeholder="Contrase&ntilde;a" name="contraactual" required>
            </td>
            </tr>
            <tr>
            <td>
            ...
            <td>
            <input type="password" placeholder="Contrase&ntilde;a" name="contra" required>
            </td>
            </tr>
            <tr>
            <td>
            ...
            <td>
            <input type="password" placeholder="Contrase&ntilde;a" name="contra1" required>
            </td>
            </tr>
            <tr> 
